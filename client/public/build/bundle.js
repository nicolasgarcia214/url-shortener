...
var app = (function () {
    ...
    /* src\pages\Main\containers\Form\Form.svelte generated by Svelte v3.29.4 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			label1.textContent = "Optional. Custom micro url:";
    			t4 = space();
    			input1 = element("input");
    			t5 = space();
    			input2 = element("input");
    			attr_dev(label0, "for", "url");
    			add_location(label0, file, 2, 8, 85);
    			attr_dev(input0, "type", "url");
    			attr_dev(input0, "name", "url");
    			attr_dev(input0, "id", "url");
    			input0.required = true;
    			add_location(input0, file, 3, 8, 135);
    			attr_dev(label1, "for", "slug");
    			add_location(label1, file, 4, 8, 192);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "slug");
    			attr_dev(input1, "id", "slug");
    			add_location(input1, file, 5, 8, 255);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Create";
    			add_location(input2, file, 6, 8, 306);
    			attr_dev(form, "action", "javascript:;");
    			attr_dev(form, "onsubmit", "createUrl(displayResponse)");
    			add_location(form, file, 1, 1, 9);
    ...
    /* src\pages\Main\Main.svelte generated by Svelte v3.29.4 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Tiny Url";
    			t1 = space();
    			create_component(form.$$.fragment);
    			add_location(h1, file$1, 6, 8, 110);
    			add_location(main, file$1, 5, 4, 94);
